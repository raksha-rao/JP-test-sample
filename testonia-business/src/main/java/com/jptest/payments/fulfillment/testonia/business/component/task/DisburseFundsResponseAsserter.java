...
/**
 * 
 * Validating the DisburseFunds PaymentMessage response
 */


public class DisburseFundsResponseAsserter implements PaymentMessageResponseAsserter {

	public void validateResponse(PaymentMessagePb.PaymentMessage paymentMessage, String validationString) {

        Assert.assertNotNull(
                StringUtils.trimToNull(
                        paymentMessage.getFinancialAuthorization().getTransactions(0).getTransactionHandle()),
				this.getClass().getSimpleName()
						+ ". validateResponse() failed for Transaction Handle should not be null");
        Assert.assertNotNull(paymentMessage.getFinancialAuthorization().getTransactions(0).getStatusInfo()
        ...
        Assert.assertNotNull(paymentMessage.getFinancialAuthorization().getTransactions(0).getPaymentInstructions(0)
				.getInstrumentHolder(),
				this.getClass().getSimpleName()
        ...
        Assert.assertNotNull(
                paymentMessage.getFinancialAuthorization().getTransactions(0).getPaymentInstructions(0)
