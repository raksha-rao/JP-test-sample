...
/**
 * This service creates Disburse_Funds PaymentMessage request for a unilateral transaction with Email
 */
@Singleton
public class DisburseFundsUnilateralEmailPaymentMessageCreatorService
    ...
    public PaymentMessagePb.PaymentMessage.Builder constructPaymentMessage(final String currency,
        ...
        final PaymentMessagePb.PaymentMessage.Builder paymentMessageBuilder = PaymentMessagePb.PaymentMessage
                .newBuilder();
        final String email = UserUtility.createEmail();
        final Receiver.Builder receiverBuilder = Receiver.newBuilder()
                .setUserIdentifier(UserIdentifier.newBuilder().setEmailAddress(email).build());
