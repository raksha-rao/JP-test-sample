...
public class PreCreatedTransactionPayResponseGenerationTask extends BaseTask<FulfillPaymentResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(PreCreatedTransactionPayResponseGenerationTask.class);
    ...
    /**
     * Get the Encrypted Transaction ID from Account Number using WTransactionP20DaoImpl and CryptoUtil
     *
     * @param accountNumber
     * @return
     */
