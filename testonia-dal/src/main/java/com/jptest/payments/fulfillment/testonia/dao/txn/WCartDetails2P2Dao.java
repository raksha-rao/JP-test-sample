...
/**
 * Represents WCART_DETAILS2_P2 table of TXN database
 */
@Singleton
public class WCartDetails2P2Dao extends TxnDao {

    private static final String GET_WXCLICK_URL_P2_DETAILS_QUERY = "SELECT * FROM WCART_DETAILS2_P2 where trans_data_map_id in "
            + "(select MAP_ID from WTRANS_DATA_MAP_P2 where transactionlike_id in ({commaSeparatedIds}) and transactionlike_type = 'T' and BITAND(FLAGS, 32) > 0) "
    ...
    private static final String ITEM_UPC_COL = "ITEM_UPC";
    private static final String OPTION_NAME1_COL = "OPTION_NAME1";
    private static final String OPTION_SELECTION1_COL = "OPTION_SELECTION1";
    private static final String QUANTITY_UNIT_COL = "QUANTITY_UNIT";
    private static final String RETURN_POLICY_IDENTIFIER_COL = "RETURN_POLICY_IDENTIFIER";
    ...
    public List<WCartDetailsDTO> getCartDetails(List<WTransactionDTO> transactions) {
        ...
        for (Map<String, Object> result : queryResult) {
            ...
            wCartDetails.setItemDescription(getString(result.get(ITEM_DESCRIPTION_COL)));
            ...
            wCartDetails.setItemUpc(getString(result.get(ITEM_UPC_COL)));
            wCartDetails.setOptionName1(getString(result.get(OPTION_NAME1_COL)));
            wCartDetails.setOptionSelection1(getString(result.get(OPTION_SELECTION1_COL)));
            ...
            wCartDetails.setReturnPolicyIdentifier(getString(result.get(RETURN_POLICY_IDENTIFIER_COL)));
