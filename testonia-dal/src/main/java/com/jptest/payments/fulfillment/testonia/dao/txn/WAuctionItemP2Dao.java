...
/**
 * Represents WAUCTION_ITEM_P2 table of TXN database
 */
@Singleton
public class WAuctionItemP2Dao extends TxnDao {

    private static final String GET_WAUCTION_ITEM_P2_DETAILS_QUERY = "SELECT * FROM WAUCTION_ITEM_P2 where id in ({auctionItemIds}) order by id";

    private static final String AUCTION_TIME_COL = "AUCTION_TIME";
    private static final String BID_AMOUNT_COL = "BID_AMOUNT";
    ...
    /**
     * Queries WAUCTION_ITEM_P2 table for input transaction
     *
     * @param commaSeparatedAuctionItemIds
     * @return
     */
    public List<WAuctionItemDTO> getWAuctionItemDetails(String commaSeparatedAuctionItemIds) {
        String query = GET_WAUCTION_ITEM_P2_DETAILS_QUERY.replace(AUCTION_ITEM_ID_REPLACEMENT_TOKEN,
