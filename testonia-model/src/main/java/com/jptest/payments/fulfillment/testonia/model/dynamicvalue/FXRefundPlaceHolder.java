...
/**
 * Placeholder for FX-Refund related dynamic values e.g.
 * ${FX-REFUND:AMOUNT-FROM(USD,1000,CAD,CA,TRUE,CONVERT_SEND)}
 * 
 * <p>
 ...
 * <li>${FX-REFUND:AMOUNT-FROM(USD,1000,CAD,CA,TRUE,CONVERT_SEND)} :
 * some-value</li>
 * <li>${FX-REFUND:AMOUNT-TO(USD,1000,CAD,CA,TRUE,CONVERT_SEND)} :
 * some-value</li>
 * <li>${FX-REFUND:EXCHANGE-RATE(USD,1000,CAD,CA,TRUE,CONVERT_SEND)} :
 * some-value</li>
 * <li>${FX-REFUND:AUDIT-TRAIL(USD,1000,CAD,CA,TRUE,CONVERT_SEND)} :
 * some-value</li>
 */
public class FXRefundPlaceHolder extends AbstractFXPlaceHolder {

	// placeholder prefix for FX is "${FX-REFUND:"
	public static final String FUNCTION_NAME = "FX-REFUND";
	public static final String FX_REFUND_PLACEHOLDER_PREFIX = PLACEHOLDER_PREFIX + FUNCTION_NAME + FIELD_DELIMITER;
	...
	public FXRefundPlaceHolder(String placeholder) {
		super(placeholder);
	...
	public String buildKey(String fieldName) {
		return FX_REFUND_PLACEHOLDER_PREFIX + fieldName + FUNCTION_PREFIX + getParameters() + FUNCTION_SUFFIX
				+ PLACEHOLDER_SUFFIX;
	}
	...
	/**
	 * Set FX-Refund related values in map from input response
	 * 
	 * @param response
	 */
	public void setValues(CurrencyConvertRefundCustomerResponse response) {
		...
		addKeyValue(FIELD_FEE_AUDIT_TRAIL, String.valueOf(response.getConversionInfoOut().getFxAuditTrail()
				.getConversionDetails().getFeeAuditTrail().getSerializedAuditTrail()));
